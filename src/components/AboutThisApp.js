...
const AboutThisApp = (props) => {
  ...
  return (
    <div>
      ...
      <p>{props.sitename} is a small web app for finding information about all of your favorite movies.  It uses <a href="https://developers.themoviedb.org/3/getting-started">The Movie Database API</a>.  I hope you enjoy it.</p>
      <h2>Behavior</h2>
      <ol>
        ...
        <li>A user can return to the popular movie search results by simply hitting enter in the Movie Search Bar with a blank entry.</li>
      </ol>
      ...
      <ol>
        ...
        <li>The client/UI was created with React, Reach-Router and Semantic-UI.</li>
      </ol>
    </div>
  );
};
